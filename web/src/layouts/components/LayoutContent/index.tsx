...
const LayoutContent = () => {
    ...
    const setPageTitle = () => {
        ...
        if (title) {
            document.title = title + ' - ' + getSetting('appName')
        }
    }
            ...
            <div className="flex-1">
                <Scrollbars autoHide
                    ...
                    <QueueAnim className="relative"
                               type={[getSetting('theme.animateInType'), getSetting('theme.animateOutType')]}
                               duration={[getSetting('theme.animateInDuration'), getSetting('theme.animateInDuration')]}>
